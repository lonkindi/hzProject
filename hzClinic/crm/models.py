...
class MedCard(models.Model):
    ...
    PerZ = models.CharField(max_length=1024, verbose_name='Перенесённые и хронические заболевания?')
    PerO = models.CharField(max_length=1024, verbose_name='Перенесённые пластические операции')
    PerT = models.CharField(max_length=1024, verbose_name='Перенесённые травмы')
    PerG = models.CharField(max_length=1024, verbose_name='Перенесённые гемотрансфузии')
    Allerg = models.CharField(max_length=1024, verbose_name='Аллергии')
    ...
    MedPrep = models.CharField(max_length=1024, verbose_name='Лекарственные препараты на постоянной основе')
    MedIzd = models.CharField(max_length=1024, verbose_name='Медицинские изделия')
